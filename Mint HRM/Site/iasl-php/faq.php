            ...
            <div class="container">
                <div class="page-title">
                    ...
                    <ul>
                        ...
                        <li>Importance of Life Insurance</li>
                    </ul>
                </div><!-- Page Title -->
            </div>
        </div><!-- Page Top -->
                            ...
                            <div class="charity-events">
                                <div class="events">
                                    ...
                                    <div class="event-toggle">
                                        ...
                                        <div class="event-bar">
                                            <div class="col-xs-12">
                                                <h3 class="news-title"><a itemprop="url" href="faq-details-safty.php" title="">Create a safety net for your loved ones with a life insurance.</a></h3>
                                            </div>
                                        </div>
                                    </div><!-- Event Toggle -->
                                    <div class="event-toggle">
                                        ...
                                        <div class="event-bar">
                                            <div class="col-xs-12">
                                                <h3 class="news-title"><a itemprop="url" href="faq-detail-ibsl.php" title=""><i class="small">"Life is uncertain, so Life Insurance is essential"</i><br>Says Damayanthi Fernando, Director General of Insurance Board Life insurance claims paid in 2014  amounted to Rs. 21 Billion</a></h3>
                                            </div>
                                        </div>
                                    </div><!-- Event Toggle -->
                                    <div class="event-toggle">
                                        <div class="event-date"><strong>03</strong></div>
                                        <div class="event-bar">
                                            <div class="col-xs-12">
                                                <h3 class="news-title"><a itemprop="url" href="faq-details-insurance-ombudsman.php" title="">Life Insurance is “Sold”, not "Bought". This must change!</a></h3>
                                            </div>
                                        </div>
                                    </div><!-- Event Toggle -->
                                    <div class="event-toggle">
                                        <div class="event-date"><strong>04</strong></div>
                                        <div class="event-bar">
                                            <div class="col-xs-12">
                                                <h3 class="news-title"><a itemprop="url" href="faq-detail-iasl-daily-mirror-suplement.php" title="">IASL Undertakes to Create Life Insurance Awareness Among Sri Lankans</a></h3>
                                            </div>
                                        </div>
                                    </div><!-- Event Toggle -->
