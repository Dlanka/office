                    ...
                    <div class="row">
                        ...
                        <div class="col-md-5">
                            <div class="row">
                                ...
                                <div class="col-md-12">
                                    <div class="drop-section emp-list-container">
                                    ...
                                    <div class="dropArea" data-location="">Drag and drop here</div>
                                </div>
...
<script>
    $('.scroll-element .selectable ').on('click', function () {
        $('.scroll-element .selectable ').removeClass('selected');
...
//        var argVal = Number.parseFloat(val);
//        var currVal = Number.parseFloat(resultText.text());
...
<script>
    $(function () {
        ...
        $(".scroll-empList .sc-emp-list .u-name").draggable({
            helper: "clone",
            revert: true,
            revertDuration: 400,
            zIndex: 999,
        ...
        $(".dropArea").droppable({
            accept: ".scroll-empList .sc-emp-list .u-name",
            drop: function (evt) {

                var item = appendItemCommitte(name, empId);
...
//        hideBtnArea();
        ...
        function appendItemCommitte(name, id) {
