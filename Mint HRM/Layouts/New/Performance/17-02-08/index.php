...
<div class="contert-wrapper mb-30 pb-30">
    ...
    <div class="col-md-12 mt-30">
        ...
        <div class="col-md-12">
                ...
                <div id="step6" class="ui-box-wrp pr-0">
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            ...
                            <div id="indtragets" class="ui-sm-accordion block-relative">
                                ...
                                <div id="indtraget" class="ui-sm-box-wrp">
                                    <div class="row mb-15">
                                        ...
                                        <h6 class=" col-md-4 title">Edit Accept</h6>
                            ...
                            <!-- Finalizer-->
                            <div id="finalizers" class="ui-sm-accordion block-relative">
                                <a href="#finalizer" class="ui-sm-link">Finalizer</a>
                                <div id="finalizer" class="ui-sm-box-wrp">
                                    <div class="row ">
                                            ...
                                            <div class="row">
                                                <div class="col-md-12 ">
                                                    <div class="row list-row">
                                                        <h5 class="selectable details col-md-12 f-16 txt-limit-180">
                                                            Group 1
                                                        </h5>
                                                    </div>
                                                    <div class="row list-row">
            ...
            <!-- Committee -->
            <div class="ui_accordion">
                <a href="#step3" class="ui-link d-block ">
                    Committee
                </a>
                <div id="step3" class="ui-box-wrp pr-0">
                    <div class="row">
                        ...
                        <div class="col-md-7">
                            ...
                            <div class="row">
                                <div class="col-md-12 sc-wrapper">
                                    <i class="ic_search"></i>
                                    <input class="input-search" id="search_txt" name="search_txt"
                                           onkeyup="viewCoverupData(1);" placeholder="Search" type="text">
                                </div>
                            </div>
                                            ...
                                            <div class="row">
                                                <div class="col-md-12">
                                                    <div class="emp-block mt-5 search-emp">
                                                        ...
                                                        <div class="emp-info">
                                                            <h5 class="u-name">607</h5>
                                                            <h6 class="title">Assistant Technical Manager</h6>
                                                        </div>
                        ...
                        <div class="col-md-5">
                            <div class="row">
                                ...
                                <div class="col-md-12">
                                    <div class="empAppend drop-section emp-list-container">
                                        <div class="emp-list-wrp">
                                            <div class="emp-list remove_86" id="86">
                                                <div class="img-wrp--35 ">
                                                    <?php echo Common::showEmployeeThumbnailx35(0) ?>
                                                </div>
                                                <div class="tip tip-emp-name"> kamal</div>
                                                <button class="quick-delete delete-emp" onclick="deleteCoverup(86)"
                                                        type="button"></button>
                                            </div>
                                            <div class="emp-list remove_89" id="89">
                                                <div class="img-wrp--35 ">
                                                    <?php echo Common::showEmployeeThumbnailx35(0) ?>
                                                </div>
                                                <div class="tip tip-emp-name"> 607</div>
                                                <button class="quick-delete delete-emp" onclick="deleteCoverup(89)"
                                                        type="button"></button>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="dropArea" data-location="empAppend">Drag and drop here</div>
                                </div>

                                <div class="col-md-12">
                                    <button class="bx-but bx-save bx-mb-0">Save</button>
                                </div>
                            </div>
                            ...
                            <div class="row mt-30">
                                <div class="col-md-12 ">
                                    <div class="row list-row">
                                        <h5 class="txt-dark-light details col-md-9 f-16 txt-limit-180">
                                            Group 1
                                        </h5>
                                        <div class="col-md-3">
            ...
            <!-- Assign Committee-->
            <div class="ui_accordion">
                <a href="#step7" class="ui-link">
                    Assign Committee
                </a>
                <div id="step7" class="ui-box-wrp pr-0">

                    <div class="row">

                        <div class="col-md-7">
                            <!-- Committee-->
                            <div id="s-committee" class="ui-sm-accordion block-relative">
                                <a href="#sub_comt" class="ui-sm-link">Committee</a>
                                <div id="sub_comt" class="ui-sm-box-wrp">

                                    <div class="col-md-7">
                                        <div class="row">
                                            <div class="col-md-12 mb-20">
                                                <div class="row">
                                                    <div class="assign drop-section emp-list-container">
                                                        <div class="emp-list-wrp">
                                                            <div class="emp-list remove_86" id="86">
                                                                <div class="img-wrp--35 ">
                                                                    <?php echo Common::showEmployeeThumbnailx35(0); ?>
                                        ...
                                        <div class="row">
                                            <div class="drop-section group-wrp">
                                                <div class="group-container grupItem">
                                                    <div id="gp_id2" class="group">
                                                        <div class="title-wrp">
                                                            <span class="tx_title">Su. Superior</span>
                                                        </div>
                                                        <button class="quick-delete" type="button"></button>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                                    ...
                                    <div class="col-md-5">
                                        <div class="row drop-zone">
                                            <div class="dropArea" data-location="sub_comt">Drag
                                                and drop
                                                here
                                            </div>
                                        </div>
                            ...
                            <div id="s-committee2" class="ui-sm-accordion block-relative">
                                <a href="#sub_comt2" class="ui-sm-link">Committee-2</a>
                                <div id="sub_comt2" class="ui-sm-box-wrp">
                                    ...
                                    <div class="col-md-5">
                                        <div class="row drop-zone">
                                            <div class="dropArea" data-location="sub_comt2">Drag
                                                and drop
                                                here
                                            </div>
                                        </div>
                        ...
                        <div class="col-md-5">
                            <div class="row">
                                <ul class="group-list drop-item-list drop-list-assign-cm">
                                    <li id="id1">
