                        ...
                        <div class="col-md-12 ">
                            ...
                            <div class="row">
                                <div class="col-md-12">
                                    ...
                                    <div class="row form-row">
                                        <div class="col-md-4 input-layout">
                                            <input class="datepicks startDate" type="text">
                                            <label for="">Start Date</label>
                                        </div>
                                        <div class="col-md-4 input-layout">
                                            <input class="datepicks endDate" type="text">
                                        ...
                                        <div class="row mt-30">
                                            <div class="col-md-8">
                                                <div class="row">
                                                    ...
                                                    <div class="col-md-6">
                                                        <div class="row">
                                                            <div class="col-md-12">
                                                                <div class="table-block cell-width-100 active-img">
                                                                    <div class="cell zero-width">
                                                                        <div class="ml-5 img-wrp--50 with-border">
                                                                            <div>
                                                                                <?php echo Common::showEmployeeThumbnailx50(0); ?>
                                                                            </div>
                                                                        </div>
                                                                    </div>
                                                                    <div class="cell pl-20">
                                                                        <h5 class="details up-case">Natsha
                                                                            Guawardane</h5>
                                                            ...
                                                            <div class="col-md-12 mt-60">
                                                                <h5 class="txt-dark-light">
                                                                    <i class="img-status checked mr-10"></i>
                                                                    <span class="f-regular">Suggested</span>
                                                                </h5>
                                                            </div>
                                                        </div>
                                                    </div>
                                                        ...
                                                        <div class="row">
                                                            <div class="col-md-12">
                                                                <div class="table-block cell-width-100">
                                                                    <div class="cell zero-width">
                                                                        <div class="img-wrp--50 with-border">
                                                                            <div>
                                                                                <?php echo Common::showEmployeeThumbnailx50(0); ?>
                                                                            </div>
                                                                        </div>
                                                                    ...
                                                                    <div class="cell pl-20">
                                                                        <h5 class="details up-case">Chathuri
                                                                            GaneshaN</h5>
                                                                        <h6 class="title">UX Designer</h6>
                                                                    </div>
                                                                </div>
                                                            ...
                                                            <div class="col-md-12 mt-30">
                                                                <button
                                                                    class="float-left bx-sm-but bx-save bx-m-0 mr-15 mt-15 ">
                                                                    Accept
                                                                </button>
                                                                <button
                                                                    class="float-left bx-sm-but bx-edit bx-m-0 mr-15 mt-15">
                                                                    Edit
                                                                </button>
                                                            </div>
                                            ...
                                            <div class="col-md-4 mb-15">
                                                <ul class="comment-list max-h-270 ">
                                                    <li>
                                                        <div class="table-block cell-witdh-100 v-top">
                                                            <div class="cell zero-width">
                                                            ...
                                                            <div class="cell pl-15">
                                                                <p class="txt-dark">
                                                                    <span
                                                                        class="commenter mr-5">Chathuri Ganeshan</span>
                                                                    <span class="comment">
                                                    ...
                                                    <li>
                                                        <div class="table-block cell-witdh-100 v-top">
                                                            ...
                                                            <div class="cell pl-15">
                                                                ...
                                                                <h6 class="title float-right mt-5">February 19</h6>
                                                            </div>
                                                        </div>
                                                    </li>
                                                    <li>
                                                        <div class="table-block cell-witdh-100 v-top">
                                                            ...
                                                            <div class="cell pl-15">
                                                                ...
                                                                <h6 class="title float-right mt-5">Yesterday</h6>
                                                            </div>
                                                        </div>
                                                    </li>
                                                    <li>
                                                        <div class="table-block cell-witdh-100 v-top">
                                                            ...
                                                            <div class="cell pl-15">
                                                                ...
                                                                <h6 class="title float-right mt-5">Now</h6>
                                                            </div>
                                                        </div>
                                                    </li>
                                                </ul>
                            ...
                            <div class="box-body">
                                <div class="col-md-12">
                                    <div class="col-md-12">
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="col-md-6">
                                                        <div class="row">
                                                            ...
                                                            <div class="col-md-12 mb-20 rangeSlider-wrp">
                                                                <output class="text-right txt-dark mb-10">0%</output>
                                                                <input type="range" class="rangeSlider">
                                                            </div>

                                                            <div class="col-md-12 textarea-layout">
                                                                <textarea class="h-60" name="" id="" cols="30"
                                                                          rows="10"></textarea>
                                                            </div>

                                                            <div class="col-md-12">
                                                                <button class="bx-sm-but bx-save">Update</button>
                                                            </div>
                                                                ...
                                                                <div class="emp-list-container">
                                                                    <div class="emp-list-wrp ">
                                                                        ...
                                                                        <div class="emp-list" id="emp_1">
                                                                            ...
                                                                            <div class="tip tip-emp-name">Nirmal
                                                                                Fernndo
                                                                            </div>
                                                                        </div>
                                                                        <div class="emp-list" id="emp_2">
                                                                            <div class="img-wrp--35 ">
                                                                                <?php echo Common::showEmployeeThumbnailx35(0); ?>
                                                                            </div>
                                                                            <div class="tip tip-emp-name">Nirmal
                                        ...
                                        <div class="row ">
                                            <div class="col-md-12">
                                                <button class="bx-but bx-exit bx-mb-0">Finish</button>
                                            </div>
                                        </div>
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="col-md-6">
                                                        <div class="row">
                                                            ...
                                                            <div class="col-md-12">
                                                                <button class="bx-sm-but bx-save">Accept</button>
                                                            </div>
                                                        </div>
                                                    </div>
                                                    ...
                                                    <div class="col-md-6">
                                                        <div class="row">
                                                            ...
                                                            <div class="col-md-12 mt-60">
                                                                <h5 class="txt-dark-light">
                                                                    <i class="img-status edit mr-10"></i>
                                                                    <span class="f-regular">Modified</span>
                                                                </h5>
                                                            </div>
...
<script>
    ...
    function loadRangeSlider(ele) {

        var $input;
        $('input.rangeSlider').on('input', function (e) {
            $input = $(e.target);
            $input.parents('.rangeSlider-wrp').find('output').text($input.val() + '%');
        });

        rangesliderJs.create($('input.rangeSlider'), {
            min: 0,
            max: 100,
            value: 0,
            step: 1,
