                                ...
                                <div class="col-md-12 scroll-cln">
                                    <div class="interview-cln ">
                                        ...
                                        <div class="cln-row">
                                            ...
                                            <div id="time_10" class="col-md-10 cln-drop" data-time="10:00"></div>
                                        </div>
                                        <div class="cln-row">
                            ...
                            <ul class="candidate-list">
                                <li id="cnd_10">
                                    ...
                                    <div class="cn-body">
                                        ...
                                        <div class="status">
                                            <i class="ic_20 ic_20_clock-yellow btnPending"></i>
                                            <i class="ic_20 ic_20_clock-red btnReject"></i>
                                        </div>
                                        <p class="textCnt">Lorem Ipsum is simply Lorem Ipsum is Lorem Ipsum</p>
                                        <div class="textarea-layout noteCnt">
                                            <textarea name="" id="" cols="30" rows="10"></textarea>
                                        </div>
                                        <div>
                                            <button class="bx-sm-but bx-edit btnEditCnt">Edit</button>
                                        </div>
                                    </div>
                                </li id>
        ...
        <div class="col-md-8">
            <div class="row">
                ...
                <div class="col-md-4">
                    ...
                    <div class="ui_accordion">
                        <a href="#options" class="ui-link ">Options</a>
                        ...
                        <div class="col-md-12 mb-30">
                            <div class="row header-row mb-5">
                                <div class="col-md-6 but-gruop-wrp mb-0">
                                    <label>
                                        <input type="checkbox" class="allSelect">
                                        <span class="check-box"></span>
                                        <span class="pl-5 font-12">Select All</span>
                                    </label>
                                </div>
                                <div class="col-md-6">
                                    <div class="row">
                            ...
                            <div class="scroll-body">
                                <div class="row body-row mb-5">
                                    <div class="col-md-6">
                                        <div class="row">
                                            <h5 class="details col-md-5">Natasha Gunawardhane</h5>
...
<script>
    ...
    $(function () {
        ...
        $('.btnPending').click(function () {
            if ($(this).hasClass('ic_20_clock-yellow')) {
                $(this).removeClass('ic_20_clock-yellow')
                    .addClass('ic_20_clock-yellow-fill');
            } else {
                $(this).addClass('ic_20_clock-yellow')
                    .removeClass('ic_20_clock-yellow-fill');
            }

        });

        $('.btnReject').click(function () {
            if ($(this).hasClass('ic_20_clock-red')) {
                $(this).removeClass('ic_20_clock-red')
                    .addClass('ic_20_clock-red-fill');
            } else {
                $(this).addClass('ic_20_clock-red')
                    .removeClass('ic_20_clock-red-fill');
            }
