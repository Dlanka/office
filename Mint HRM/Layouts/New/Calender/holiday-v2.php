                    ...
                    <div class="col-md-5 mt-30">
                        <div class="but-gruop-wrp mb-0">
                            <label>
                                ...
                                <span>Apply for all <span id="selectedDay">Monday</span> </span>
                            </label>
                        </div>
                        ...
                        <div class="date-container">
                            <div class="date holiday">
                                <div class="header">
                                    ...
                                    <span class="h_day-type">Holiday</span>
                                </div>
                                <div class="content">
                            ...
                            <div class="date half-holiday">
                                <div class="header ">
                                    <span class="num">1</span>
                                    <span class="h_day-type" title="Half Holiday">Half Holiday</span>
                                </div>
                                <div class="content"></div>
                            </div>
                            <div class="date">
                            ...
                            <div class="date holiday">
                                <div class="header">
                                    ...
                                    <span class="h_day-type">Poya Day</span>
                                </div>
                                <div class="content">
                                </div>
                            </div>
